                          ...
                          <Col className="shadow-sm bg-white pb-3 mt-4" md={12} lg={12} sm={12} xs={12}>
                              <Row>
                                  <Col className="p-3" md={6} lg={6} sm={12} xs={12}>
                                      <img className="w-100" src={this.props.product_data.image} />
                                  ...
                                  <Col className="p-3 " md={6} lg={6} sm={12} xs={12}>
                                      <h5 className="Product-Name">{this.props.product_data.title}</h5>
                                      <h6 className="section-sub-title">--------</h6>
                                      <div className="input-group">
                                          <div className="Product-price-card d-inline ">Reguler Price {this.props.product_data.price}</div>
                              ...
                              <Row>
                                  <Col className="" md={6} lg={6} sm={12} xs={12}>
                                      ...
                                      <p>{this.props.product_data.title}</p>
